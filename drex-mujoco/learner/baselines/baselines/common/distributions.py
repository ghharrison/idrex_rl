...
class PdType(object):
    ...
    def param_placeholder(self, prepend_shape, name=None):
        return tf_v1.placeholder(dtype=tf.float32, shape=prepend_shape+self.param_shape(), name=name)
    def sample_placeholder(self, prepend_shape, name=None):
        return tf_v1.placeholder(dtype=self.sample_dtype(), shape=prepend_shape+self.sample_shape(), name=name)
...
class DiagGaussianPdType(PdType):
    ...
    def pdfromlatent(self, latent_vector, init_scale=1.0, init_bias=0.0):
        ...
        logstd = tf_v1.get_variable(name='pi/logstd', shape=[1, self.size], initializer=tf.zeros_initializer())
...
class DiagGaussianPd(Pd):
    ...
    def sample(self):
        return self.mean + self.std * tf_v1.random_normal(tf.shape(self.mean))
    @classmethod
    def fromflat(cls, flat):
        return cls(flat)
